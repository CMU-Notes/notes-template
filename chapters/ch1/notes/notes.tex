...
\newtcolorbox{thmbox}[1][]{colback=blue!4, colframe=blue!50!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.5pt, arc=2pt, breakable}
\newtcolorbox{exbox}[1][]{colback=orange!5, colframe=orange!60!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.5pt, arc=2pt, breakable}
\newtcolorbox{whybox}[1][]{colback=purple!4, colframe=purple!50!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.5pt, arc=2pt, breakable}
\newtcolorbox{sumbox}[1][]{colback=yellow!8, colframe=yellow!60!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.5pt, arc=2pt, breakable}
\newtcolorbox{codebox}[1][]{colback=gray!5, colframe=gray!70!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable,
  fontupper=\ttfamily\small}
\newtcolorbox{algobox}[1][]{colback=teal!4, colframe=teal!50!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable}

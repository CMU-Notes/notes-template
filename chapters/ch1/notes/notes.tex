...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Decay of $2^{-k}$: later components are negligible.}\label{fig:decay}
\end{figure}
...
\end{tikzpicture}
\caption{Diagonal argument: entries along the diagonal form the limit.}\label{fig:diagonal}
\end{figure}

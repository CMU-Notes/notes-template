...
\newtcolorbox{qeasy}[1][]{colback=green!5, colframe=green!50!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable,
  left=4pt, right=4pt, top=3pt, bottom=3pt, after skip=8pt}
\newtcolorbox{qmedium}[1][]{colback=yellow!8, colframe=orange!70!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable,
  left=4pt, right=4pt, top=3pt, bottom=3pt, after skip=8pt}
\newtcolorbox{qhard}[1][]{colback=red!4, colframe=red!50!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable,
  left=4pt, right=4pt, top=3pt, bottom=3pt, after skip=8pt}
\newtcolorbox{solution}[1][]{colback=gray!4, colframe=gray!60!black,
  fonttitle=\bfseries, title={#1}, boxrule=0.4pt, arc=2pt, breakable,
  left=4pt, right=4pt, top=3pt, bottom=3pt, after skip=8pt}
